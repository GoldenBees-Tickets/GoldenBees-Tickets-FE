    ...
    return(
        <div className="font-[sans-serif] bg-white">
            <div className="lg:max-w-6xl max-w-xl mx-auto p-4">
                <h2 className="text-gray-800 text-3xl font-extrabold text-center">Meet Our Team</h2>
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 max-md:justify-center mt-12">
                    ...
                    <div className="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                        <img src="https://readymadeui.com/team-1.webp" className="w-full sm:h-60 object-cover" />
                        ...
                        <div className="p-4">
                            ...
                            <div className="mt-4">
                                <p className="text-gray-600 text-sm leading-relaxed">Eiusmod commodo aliquip laboris qui anim non voluptate consectetur.</p>
                            </div>
                    ...
                    <div className="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                        <img src="https://readymadeui.com/team-3.webp" className="w-full sm:h-60 object-cover" />
                    ...
                    <div className="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                        <img src="https://readymadeui.com/team-4.webp" className="w-full sm:h-60 object-cover" />
                    ...
                    <div className="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                        <img src="https://readymadeui.com/team-5.webp" className="w-full sm:h-60 object-cover" />
